...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_LSFT, KC_SCLN, KC_Q, KC_J, KC_K, KC_X, KC_MUTE,                                 KC_NO, KC_B, KC_M, KC_W, KC_V, KC_Z, KC_RSFT,
           KC_GRV, MO(1), KC_LALT, KC_LCTL, KC_LGUI,                                        KC_ENT, KC_SPC, KC_RALT, KC_HYPR, KC_LBRC
      ),
  [1] = LAYOUT(
  ...
  [2] = LAYOUT(
         KC_EQL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,
              KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                        KC_PGUP, KC_BTN1, KC_MS_U, KC_BTN2, LCTL(KC_BSPC), KC_BSPC,
      KC_TRNS, KC_NO, KC_NO, LGUI(KC_TAB), LGUI(KC_TILD), KC_NO,                                          KC_PGDN, KC_MS_L, KC_MS_D, KC_MS_R, KC_DEL, KC_BSPC,
  ...
  [3] = LAYOUT(
          ...
          RESET, KC_NO, KC_NO, KC_NO, CG_TOGG, KC_NO,                                                   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
          KC_NO, KC_NO, CG_TOGG, KC_NO, KC_NO, KC_NO,                                                   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
